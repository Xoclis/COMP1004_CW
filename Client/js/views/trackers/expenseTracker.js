function expenseTracker() {
    ...
    <form id="expense-form" style="margin-bottom: 20px;">
      <div style="margin-bottom: 15px;">
        ...
        <input type="text" id="inputName" placeholder="Enter expense name" style="width: 100%;">
      </div>
      <div style="margin-bottom: 15px;">
        <label for="inputAmount" style="margin-bottom: 5px; display: block;">Amount</label>
        <input type="number" id="inputAmount" placeholder="Enter expense amount" style="width: 100%;">
      </div>
      <div style="margin-bottom: 15px;">
        <label for="inputDate" style="margin-bottom: 5px; display: block;">Date</label>
        <input type="date" id="inputDate" placeholder="Enter expense date" style="width: 100%;">
      </div>
      <div style="margin-bottom: 15px;">
        <button type="submit" style="padding: 10px 20px; background-color: #007bff; color: #fff; border: none; border-radius: 5px; cursor: pointer;">Submit</button>
      </div>
    </form>
